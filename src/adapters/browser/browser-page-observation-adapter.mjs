...
export function adaptBrowserCompanyResult(result = {}) {
  ...
  const items = (result.officialCandidates || []).map((candidate, index) => {
    ...
    return Object.freeze({
      ...
      verifiedTenant: candidate.verifiedTenant === true,
      officialSiteLinked: candidate.officialSiteLinked === true,
      parentOfficialVerified: candidate.parentOfficialVerified === true,
      officialAttributionUrl: canonicalHttpUrl(candidate.officialAttributionUrl) || null,
